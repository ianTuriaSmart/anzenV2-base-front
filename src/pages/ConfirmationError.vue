...
//import { apiDeleteReservation } from 'src/services/apiReservations';
...
// onMounted (() => {
//   const payment = sessionStorageUtils.get('payment');
//   const storedReservation = sessionStorageUtils.get('reservation');

//   // if (!payment || !storedReservation) {
//   //   router.push('/');
//   //   return;
//   // };
...
const exitReservation = async () => {

  try {
    // if (sessionStorageUtils.get('reservation')) {
    //   // Eliminamos reserva temporal llamando a la API
    //   await apiDeleteReservation(sessionStorageUtils.get('reservation').reservation.idReservation);
    //   sessionStorageUtils.remove('reservation');
    // };

    // Borramos también payment para cerrar el proceso de compra
    //sessionStorageUtils.remove('payment');
